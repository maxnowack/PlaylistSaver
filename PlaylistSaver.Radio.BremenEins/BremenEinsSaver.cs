...
namespace PlaylistSaver.Radio.BremenEins
{
    using PlaylistSaver.Core;
    using PlaylistSaver.Radio.Helpers.Playlistbase;

    public class BremenEinsSaver : IPlaylistSaver
    {
        private const string StationName = "Bremen Eins";
